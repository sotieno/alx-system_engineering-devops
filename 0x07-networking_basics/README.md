...
This project was the first of two introducing networking concepts. It was centred around learning about the OSI model, LAN and WAN networks, and TCP/UDP data transfer protocols through quiz-like questions and a couple of bash scripts.
